...
The repository contains the real model weights, runtime, attribution, estimation code and tests. [Rough estimation method](lib/scan/APPROXIMATE-METHOD.md) · [Geometry method](lib/scan/MEASUREMENT-METHOD.md) · [Lessons from body and face scanners](docs-research/HUMAN-SCANNING-LESSONS.md).
